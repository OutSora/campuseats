...
async def lifespan(app: FastAPI):
    app.state.mongo = AsyncMongoClient(os.getenv("MONGO_URL", "mongodb://campus:campus_dev_password@mongo:27017"))
    app.state.collection = app.state.mongo.campuseats.notifications
...
app = FastAPI(title="CampusEats Notification Service", lifespan=lifespan)
