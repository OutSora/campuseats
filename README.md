...
Проект специально сделан так, чтобы его можно было запустить на Windows одной командой и объяснить на защите. В нем есть 6 бизнес-микросервисов, Kafka и EDA, PostgreSQL, MongoDB, Valkey (совместимый с Redis), а также Nginx как маршрутизатор, балансировщик и Rate Limiter.
...
## 5. Распределение на команду из трех человек
